	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDout_trade_no" id="out_trade_no" value="QYYK<?=time()?>"></div>
				<br>
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDsubject" value="健亲宝云健康智能检测系统标准版"></div>
				<br>
				<div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
			</div>
			<div class="element">
				<div class="etitle">付款金额:</div>
				<div class="einput"><input type="text" name="WIDtotal_fee" value="9800.00"></div>
				<br>
				<div class="mark">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div>
			</div>
			<div class="element">
				<div class="etitle">商品描述:</div>
				<div class="einput"><input type="text" name="WIDbody" value="健亲宝云健康智能检测系统标准版"></div>
				<br>
